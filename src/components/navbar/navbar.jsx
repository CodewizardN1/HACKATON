            ...
            <Wrapper>
                <div className="flex items-center gap-5 h-[60px]">
                    ...
                    <div className="flex align-items-center justify-between gap-3">
                        <button className="flex align-middle gap-[3] text-white btn bg-[#E24C55] w-[200px] h-[40px] rounded-none ml-6 mr-4">
                            <svg
                        ...
                        {!localStorage.getItem("token") ? <button
                            className="btn w-[154px] h-[40px] text-white bg-[#E24C55]"
                            onClick={() =>
                                document
